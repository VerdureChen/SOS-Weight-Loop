...
TOTAL_LOOP_NUM=10
#方法设置
RETRIEVAL_MODEL_NAME=contriever # contriever bge-base llm-embedder
...
LOOP_CONFIG_PATH_NAME="${RUN_DIR}/run_configs/weight_${QUERY_DATA_NAME}_loop_config_${RETRIEVAL_MODEL_NAME}_total_loop_${TOTAL_LOOP_NUM}_${TIMESTAMP}"
mkdir -p $LOOP_CONFIG_PATH_NAME
TOTAL_LOG_DIR="${RUN_DIR}/run_logs/weight_${QUERY_DATA_NAME}_loop_log_${RETRIEVAL_MODEL_NAME}_total_loop_${TOTAL_LOOP_NUM}_${TIMESTAMP}"
